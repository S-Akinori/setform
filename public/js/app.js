...
/* harmony import */ var _components_InputGroup_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/InputGroup.vue */ "./resources/js/components/InputGroup.vue");
...
var app = new vue__WEBPACK_IMPORTED_MODULE_2__.default({
  ...
  components: {
    InputGroup: _components_InputGroup_vue__WEBPACK_IMPORTED_MODULE_1__.default
  },
  methods: {
    ...
    submitEvent: function submitEvent() {
      ...
      return true; // axios.post('/form', this.inputGroups)
...
var render = function() {
  ...
  return _c("input", {
    ...
    attrs: { id: _vm.id, type: _vm.type, name: _vm.name, value: "" }
  })
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c("textarea", {
    staticClass:
      "block border border-gray-300 rounded focus:outline-none focus:ring-1 focus:border-indigo-400",
    attrs: { name: _vm.name, id: _vm.id, rows: "5" }
  })
}
var staticRenderFns = []
render._withStripped = true
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "my-5 flex" }, [
      ...
      _c("div", { staticClass: "w-full" }, [
        !_vm.inputGroup.editable
          ? _c(
              ...
              {
                staticClass:
                  "text-xl text-center py-3 w-full rounded-lg bg-blue-100 focus:bg-white",
                on: { click: _vm.toggleTitleEditable }
              },
              [
                _vm._v(_vm._s(_vm.inputGroup.title)),
                _vm.inputGroup.required
                  ...
                  return _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        {
                          staticClass:
                            "bg-red-200 rounded-full h-5 w-5 mx-2 flex items-center justify-center",
                          on: {
    ...
    _c("div", { staticClass: "ml-5 w-24" }, [
      _c("div", { staticClass: "flex my-1" }, [
        _vm.inputGroup.type == "checkbox" || _vm.inputGroup.type == "radio"
          ? _c(
              "button",
              {
                staticClass: "bg-green-200 rounded-full h-8 w-8 mx-1",
        ...
        _c(
          "button",
          {
            staticClass: "bg-red-200 rounded-full h-8 w-8 mx-1",
            on: {
              click: function($event) {
      ...
      _c(
        "button",
        {
          staticClass: "bg-pink-200 rounded-full h-8 w-8 mx-1",
